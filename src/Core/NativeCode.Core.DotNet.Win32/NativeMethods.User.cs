namespace NativeCode.Core.DotNet.Win32
{
    ...
    internal static partial class NativeMethods
    {
        ...
        [DllImport(User32, CharSet = CharSet.Auto, SetLastError = true)]
        public static extern bool SetWindowPos(IntPtr hwnd, IntPtr insertAfter, int x, int y, int cx, int cy,
            uint flags);
        ...
        [DllImport(User32, CharSet = CharSet.Auto, SetLastError = true)]
        public static extern bool SystemParametersInfo(SystemProperty uiAction, uint uiParam, ref SmallRect pvParam,
            SystemPropertyFlags fWinIni);
