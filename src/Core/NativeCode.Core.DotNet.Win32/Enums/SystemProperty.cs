...
{
    public enum SystemProperty : uint
    {
        /// <summary>
        ...
        /// bitmap,
        /// set pvParam to point to a null-terminated string containing the name of a bitmap file. Setting pvParam to "" removes
        /// the wallpaper.
        ...
        /// to a NONCLIENTMETRICS structure that receives the information. Set the cbSize member of this structure and the uiParam
        /// parameter
        ...
        /// or by application desktop toolbars. The pvParam parameter is a pointer to a RECT structure that specifies the new work
        /// area rectangle,
        ...
        /// changes
        /// the system colors to colors that have obvious contrast; you switch to this color scheme by using the Display Options in
        /// the control panel.
        ...
        /// The pvParam parameter is a pointer to a BOOL variable that receives TRUE if a screen reviewer utility is running, or
        /// FALSE otherwise.
        /// Windows NT:  This value is not supported.
        /// </summary>
        ...
        /// The value sets the shortcut keys in the keyboard property sheets by reading the registry again. The registry must be
        /// set before this flag is used. the path in
        ...
        /// To disable the feature, set the uiParam parameter to zero or 1. To enable the feature, set uiParam to a value greater
        /// than 1
        ...
        /// The pvParam parameter must point to an integer variable that receives a value. If the value is zero or 1, the feature
        /// is disabled.
        ...
        /// to generate a WM_MOUSEHOVER message. This is used only if you pass HOVER_DEFAULT in the dwHoverTime parameter in the
        /// call to TrackMouseEvent. Set the uiParam
        ...
        /// parameter.
        /// The number of lines is the suggested number of lines to scroll when the mouse wheel is rolled without using modifier
        /// keys.
        ...
        /// The pvParam parameter must point to a BOOL variable that receives TRUE if a screen saver is currently running, or FALSE
        /// otherwise.
        ...
        /// buffer. The returned string will not exceed
        ...
        /// The selection fade effect causes the menu item selected by the user to remain on the screen briefly while fading out
        /// after the menu is dismissed. The selection fade effect is possible only if the system has a color depth of more than
        /// 256 colors.
        /// Windows NT, Windows Me/98/95:  This value is not supported.
        /// </summary>
        ...
        /// if enabled or FALSE if disabled. If ToolTip animation is enabled, GETTOOLTIPFADE indicates whether ToolTips use fade or
        /// slide animation.
        /// Windows NT, Windows Me/98/95:  This value is not supported.
        /// </summary>
        ...
        /// receives
        /// the time delay. This is only enabled if SETMOUSECLICKLOCK is set to TRUE. For more information, see About Mouse Input
        /// on MSDN.
        /// Windows 2000/NT, Windows 98/95:  This value is not supported.
        /// </summary>
        ...
        /// Turns the Mouse ClickLock accessibility feature on or off. This feature temporarily locks down the primary mouse button
        /// when that button is clicked and held down for the time specified by SETMOUSECLICKLOCKTIME. The uiParam parameter
        /// specifies TRUE for on, or FALSE for off. The default is off. For more information, see Remarks and About Mouse Input on
        /// MSDN.
        /// Windows 2000/NT, Windows 98/95:  This value is not supported.
        /// </summary>
